...
export class ChatWebview {
                            ...
                            window.addEventListener('message', event => {
                                ...
                                switch (message.type) {
                                    ...
                                    case 'restoreMessage':
                                        ...
                                        break;
                                    case 'modelConfigUpdated':
                                        updateModelConfig(message.config);
                                        break;
                                    case 'restoreScrollPosition':
                                        document.documentElement.scrollTop = message.position;
                                        break;
                                    case 'restoreInput':
                                        document.getElementById('userInput').value = message.input;
                                        break;
                                }
                            });
    ...
    public async restoreMessage(message: any): Promise<void> {
        if (!this.panel) return;
    ...
    public async setModelConfig(config: AIModelConfig): Promise<void> {
